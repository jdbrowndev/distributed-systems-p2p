all: bin/main
bin/main: bin/main.o bin/server_connection.o bin/request_handler.o bin/worker_thread.o bin/client_interface.o bin/client_connection.o bin/graph_traversal.o bin/network_connection.o bin/neighbor_serializer.o bin/service_request.o bin/file_manager.o bin/globals.o
	g++ bin/main.o bin/server_connection.o bin/request_handler.o bin/worker_thread.o bin/client_interface.o bin/client_connection.o bin/graph_traversal.o bin/network_connection.o bin/neighbor_serializer.o bin/service_request.o bin/file_manager.o bin/globals.o -lpthread -o bin/main
