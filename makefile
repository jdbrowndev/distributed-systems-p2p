all: bin/main
bin/main: bin/main.o bin/server_connection.o bin/request_handler.o bin/worker_thread.o bin/client_interface.o bin/client_connection.o bin/graph_traversal.o bin/network_connection.o bin/service_request.o bin/file_manager.o bin/globals.o
	g++ bin/main.o bin/server_connection.o bin/request_handler.o bin/worker_thread.o bin/client_interface.o bin/client_connection.o bin/graph_traversal.o bin/network_connection.o bin/service_request.o bin/file_manager.o bin/globals.o -lpthread -o bin/main
...
bin/worker_thread.o: src/server/worker_thread.cc src/server/worker_thread.h src/graph_traversal.cc src/globals.cc src/service_request.cc
	g++ -c -g src/server/worker_thread.cc -o bin/worker_thread.o
bin/client_interface.o: src/client/client_interface.cc src/client/client_interface.h src/client/client_connection.h src/graph_traversal.cc src/service_request.cc src/globals.cc
	g++ -c -g src/client/client_interface.cc -o bin/client_interface.o
bin/client_connection.o: src/client/client_connection.cc src/client/client_connection.h src/network_connection.cc src/service_request.cc src/globals.cc
	g++ -c -g src/client/client_connection.cc -o bin/client_connection.o
bin/graph_traversal.o: src/graph_traversal.cc src/graph_traversal.h src/client/client_connection.cc src/service_request.cc src/globals.cc
