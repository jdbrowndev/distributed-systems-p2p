all: bin/main
bin/main: bin/main.o bin/server_connection.o bin/request_handler.o bin/worker_thread.o bin/client_interface.o bin/client_connection.o bin/graph_traversal.o bin/network_connection.o bin/neighbors_vector.o bin/print_helper.o bin/neighbor_serializer.o bin/service_request.o bin/file_manager.o bin/globals.o
	g++ bin/main.o bin/server_connection.o bin/request_handler.o bin/worker_thread.o bin/client_interface.o bin/client_connection.o bin/graph_traversal.o bin/network_connection.o bin/neighbors_vector.o bin/print_helper.o bin/neighbor_serializer.o bin/service_request.o bin/file_manager.o bin/globals.o -lpthread -o bin/main
...
bin/client_interface.o: src/client/client_interface.cc src/client/client_interface.h src/client/client_connection.h src/graph_traversal.cc src/print_helper.cc src/neighbor_serializer.cc src/service_request.cc src/globals.cc
...
bin/print_helper.o: src/print_helper.cc src/print_helper.h
	g++ -c -g src/print_helper.cc -o bin/print_helper.o
...
bin/neighbors_vector.o: src/neighbors_vector.cc src/neighbors_vector.h src/print_helper.cc
