all: bin/main
bin/main: bin/main.o bin/server_connection.o bin/request_handler.o bin/worker_thread.o bin/client_connection.o bin/network_connection.o bin/service_request.o bin/globals.o
	g++ bin/main.o bin/server_connection.o bin/request_handler.o bin/worker_thread.o bin/client_connection.o bin/network_connection.o bin/service_request.o bin/globals.o -lpthread -o bin/main
bin/main.o: src/main.cc src/server/server_connection.cc src/server/request_handler.cc src/globals.cc src/service_request.cc
